...
public class TaskTests {
	...
	public void taskTests() {
		...
		fileList.forEach(vo -> {
			Path path = Paths.get("C:\\Users\\PC\\Desktop\\bookstore-project\\upload", vo.getUploadPath(), "s_" +  vo.getUuid() + "_" + vo.getFileName());
			checkFilePath.add(path);
		});
		...
		File targetDir = Paths.get("C:\\Users\\PC\\Desktop\\bookstore-project\\upload", getFolderYesterDay()).toFile();
